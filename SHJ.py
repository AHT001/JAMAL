...
#BD Cyber Zone-BCZ
#FB : https://www.facebook.com/Hu3ainjamal	
#PAGE : NA
#Programer Sayed Hussain Jamal
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : 
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
...
\33[1;32m Welcome to
Mr Jamal hacking tool 

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : Sayed Hussain Jamalm
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Sayed Hussain Jamall
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : Jamaltech200
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			print("\033[1;32m  The Tool Created By Sayed Hussain jamal")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
	...
	def fbtua(self):
		...
		try:
			...
			os.system('xdg-open https://www.facebook.com/Hu3ainjamal')
			os.system('clear')
			print(logo) 
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using Jamal Tools...")
